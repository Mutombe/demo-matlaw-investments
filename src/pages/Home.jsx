...
/* ================================================================
   ...
   ================================================================ */
const ICON_MAP = {
  Buildings, ChartLineUp, Handshake, ShieldCheck, Briefcase, CurrencyDollar,
};


/* ================================================================
   1. HERO — Corporate Investment, Navy & Steel
   ================================================================ */
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-navy-950/90 via-navy-950/65 to-navy-950/92 z-[1]" />
      ...
      {/* Accent line */}
      <div className="absolute top-[18%] left-0 w-16 sm:w-24 h-[1px] bg-steel-400/40 z-20" />
      ...
      >
        ...
        <motion.div
          ...
          className="w-12 h-[2px] bg-steel-400 mb-6 origin-left"
        />
        ...
        <motion.p
          ...
          className="text-steel-300 text-xs sm:text-sm font-semibold uppercase tracking-[0.25em] mb-6 sm:mb-8"
        >
          {hero.badge}
        </motion.p>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-navy-700 text-white px-7 py-3.5 sm:py-4 font-heading text-sm sm:text-base uppercase tracking-wider font-semibold transition-all duration-300 hover:bg-navy-600 hover:shadow-xl hover:shadow-navy-700/20"
          >
            {hero.ctaPrimary}
        ...
        {/* Phone badge — Matlaw has a phone */}
        {business.phone && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 z-20">
        <span className="text-white/10 text-[10px] uppercase tracking-[0.4em] font-heading" style={{ writingMode: 'vertical-rl' }}>
          Matlaw Investments &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['PROPERTY INVESTMENT', 'PORTFOLIO MANAGEMENT', 'ESTATE DEVELOPMENT', 'LEGAL ADVISORY', 'CONSULTING', 'VALUATIONS', 'WEALTH BUILDING', 'STRATEGIC GROWTH'];
      ...
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-4 sm:gap-6 mx-4 sm:mx-6">
            <span className="text-steel-400 font-heading text-lg sm:text-2xl font-bold uppercase tracking-wider">
              {item}
            </span>
            <span className="text-steel-400/40 text-lg">&bull;</span>
          </span>
        ))}
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              BUILDING<br />
              <span className="text-steel-400">WEALTH.</span><br />
              BUILDING ZIMBABWE.
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
              Matlaw Investments was founded in 2005 with a clear thesis: Zimbabwe's growth potential
              was vastly undervalued. Smart, patient capital deployed into property and strategic assets
              would deliver exceptional returns over time. We were right.
            </p>
            <p className="text-white/40 text-sm leading-relaxed max-w-lg">
              What started as a single commercial property acquisition in Harare's CBD has grown into
              a diversified portfolio valued at over $100 million. We have delivered 200+ projects,
              from residential estates to commercial towers, agricultural investments, and equity positions.
            </p>
            ...
            <div className="flex gap-8 sm:gap-12">
              <div>
                <div className="text-steel-400 font-heading text-3xl sm:text-4xl font-bold">2005</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Founded</div>
              </div>
              <div>
                <div className="text-steel-400 font-heading text-3xl sm:text-4xl font-bold">200+</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Projects</div>
              </div>
              <div>
                <div className="text-steel-400 font-heading text-3xl sm:text-4xl font-bold">$100M+</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Portfolio</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Matlaw Investments property portfolio"
              ...
              {/* Badge */}
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-navy-700 text-white p-4 sm:p-6 shadow-2xl">
                <div className="text-center">
                  <div className="font-heading text-2xl sm:text-3xl font-bold leading-none">20+</div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            >
              WHAT WE <span className="text-steel-400">DO</span>
            </h2>
            <Link
              to="/services"
              className="group text-white/40 text-sm uppercase tracking-wider font-heading flex items-center gap-2 hover:text-steel-400 transition-colors"
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 z-10">
                    <span className="text-steel-400/20 font-heading text-5xl sm:text-6xl font-bold leading-none">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  <div className="absolute top-4 left-4 z-10">
                    {Icon && <Icon size={28} className="text-steel-400/60" />}
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 z-10">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-steel-400 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-500">
                      <span className="text-xs uppercase tracking-wider font-heading font-semibold">Learn More</span>
                      <ArrowRight size={14} />
                    </div>
                  </div>

                  <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-steel-400 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left z-10" />
                </Link>
              </motion.div>
            );
          })}
          ...
          {projects.map((item, i) => (
            <div key={i} className="group relative flex-shrink-0 w-[280px] sm:w-[320px] lg:w-[380px] overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                <span className="text-steel-400 font-heading text-xs uppercase tracking-wider font-semibold">
                  {String(i + 1).padStart(2, '0')}
                </span>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-4 sm:-right-8 bg-navy-950 border border-steel-400/20 p-6 sm:p-8 shadow-2xl">
              <div className="text-center">
                <div className="text-steel-400 font-heading text-4xl sm:text-5xl font-bold leading-none">
          ...
          >
            ...
            >
              WHY <span className="text-steel-400">MATLAW</span><br />
              INVESTMENTS?
            </h2>
            ...
            <div className="space-y-6">
              {whyChooseUs.points.map((point, i) => (
                ...
                >
                  <div className="w-8 h-8 bg-steel-400/10 flex items-center justify-center shrink-0 mt-0.5">
                    <CheckCircle size={18} weight="fill" className="text-steel-400" />
                  </div>
                  <div>
...
function StatsBand() {
  ...
  const stats = [
    ...
    { number: '100', suffix: 'M+', prefix: '$', label: 'Portfolio Value' },
    { number: '20', suffix: '+', label: 'Years Experience' },
    { number: '45', suffix: '+', label: 'Team Members' },
  ];

  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-steel-400/20 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-steel-400/20 to-transparent" />
          ...
          {stats.map((stat, i) => (
            ...
            >
              <div className="font-heading font-bold text-white leading-none" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
                {stat.prefix && <span className="text-steel-400">{stat.prefix}</span>}
                <AnimatedCounter target={stat.number} duration={2} />
                {stat.suffix && <span className="text-steel-400">{stat.suffix}</span>}
              </div>
    ...
    <section ref={ref} className="bg-navy-950 py-20 sm:py-28 lg:py-32 overflow-hidden">
      <div className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        <motion.div
          ...
          className="text-center"
        >
          <Quotes size={40} weight="fill" className="text-steel-400/20 mx-auto mb-8" />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="w-8 h-[2px] bg-steel-400 mb-2" />
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} size={12} weight="fill" className="text-steel-400" />
                  ))}
                </div>
              </div>
            </motion.div>
              ...
              {homeTestimonials.map((_, i) => (
                <button
                  ...
                  className={`h-[2px] transition-all duration-300 ${
                    i === active ? 'w-8 bg-steel-400' : 'w-3 bg-white/15 hover:bg-white/30'
                  }`}
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-navy-700 text-white px-8 py-4 font-heading text-sm sm:text-base uppercase tracking-wider font-semibold transition-all duration-300 hover:bg-navy-600 hover:shadow-xl hover:shadow-navy-700/20"
            >
              {homeCta.ctaPrimary}
              <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
            </Link>
